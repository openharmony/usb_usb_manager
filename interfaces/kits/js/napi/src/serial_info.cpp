    ...
    int32_t& portIdValue, UsbSerialAttr& serialAttribute)
{
    ...
    bool result = NapiUtil::JsObjectToUint32(env, obj, "baudRate", serialAttribute.baudRate_) &&
        NapiUtil::JsObjectToUint8WithDefaultValue(env, obj, "dataBits", serialAttribute.dataBits_, 8) &&
        NapiUtil::JsObjectToUint8WithDefaultValue(env, obj, "parity", serialAttribute.parity_, 0) &&
        NapiUtil::JsObjectToUint8WithDefaultValue(env, obj, "stopBits", serialAttribute.stopBits_, 0);
