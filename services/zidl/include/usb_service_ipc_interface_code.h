...
namespace USB {
    enum class UsbInterfaceCode {
        ...
        SERIAL_FUN_SERIAL_OPEN,
        SERIAL_FUN_SERIAL_CLOSE,
        SERIAL_FUN_SERIAL_READ,
        SERIAL_FUN_SERIAL_WRITE,
        SERIAL_FUN_SERIAL_GET_ATTRIBUTE,
        SERIAL_FUN_SERIAL_SET_ATTRIBUTE,
        SERIAL_FUN_SERIAL_GET_PORTLIST,
        SERIAL_FUN_HAS_SERIAL_RIGHT,
        SERIAL_FUN_ADD_SERIAL_RIGHT,
        SERIAL_FUN_CANCEL_SERIAL_RIGHT,
        SERIAL_FUN_REQUEST_SERIAL_RIGHT
    };
} // namespace USB
} // namespace OHOS
