...
#include "usbmgrparallelize_fuzzer.h"
#include <cstddef>
#include <cstdint>
...
constexpr uint32_t CODECOUNTMAX = 80;
...
bool UsbMgrParallelizeFuzzTest(const uint8_t *rawData, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::UsbMgrParallelizeFuzzTest(data, size);
    return 0;
}