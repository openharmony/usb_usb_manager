...
bool DoSomethingInterestingWithMyAPI(const uint8_t *rawData, size_t size)
{
    ...
    for (; g_usbInterfaceCode < USB_INTERFACE_CODE_COUNT; g_usbInterfaceCode++) {
        DelayedSpSingleton<UsbService>::GetInstance()->OnRemoteRequest(g_usbInterfaceCode, data, reply, option);
    }
