...
#ifndef SERIAL_ERRORS_H
#define SERIAL_ERRORS_H
...
namespace OHOS {
namespace USB {
enum SerialModuleType {
    SERIAL_MODULE_TYPE_SERVICE = 0,
    SERIAL_MODULE_TYPE_KIT = 1,
};

const std::string PERMISSION_DENIED_SYSAPI = "PERMISSION_DENIED_SYSAPI";

#define SUBSYS_SERIAL 50
#define SERIAL_OFFSET 100

constexpr int32_t SERIALFWK_SERVICE_ERR_OFFSET = ErrCodeOffset(SUBSYS_SERIAL, SERIAL_MODULE_TYPE_SERVICE);

enum SerialErrCode {
    UEC_OK = 0,

    UEC_INTERFACE_NO_MEMORY = SERIALFWK_SERVICE_ERR_OFFSET,
    ...
    UEC_INTERFACE_GET_SERIAL_SERVICE_FAILED,
    UEC_INTERFACE_ADD_DEATH_RECIPIENT_FAILED,
    UEC_INTERFACE_INNER_ERR,
    UEC_INTREFACE_END,

    UEC_SERVICE_NO_MEMORY = SERIALFWK_SERVICE_ERR_OFFSET + SERIAL_OFFSET,
    ...
    UEC_SERVICE_GET_SERIAL_SERVICE_FAILED,
    ...
    UEC_SERVICE_REMOVE_PERMISSION_ERR,
    UEC_SERVICE_ADD_PERMISSION_ERR,
    UEC_MANAGER_PORT_REPEAT_OPEN,
    UEC_MANAGER_PORT_REPEAT_CLOSE,
    UEC_MANAGER_PORT_NOT_OPEN
};

enum SerialRightErrCode {
    SERIAL_RIGHT_OK = 0,
    SERIAL_RIGHT_FAILURE = -1,
    SERIAL_RIGHT_RDB_EXECUTE_FAILTURE = -2,
    SERIAL_RIGHT_RDB_NO_INIT = -3,
    SERIAL_RIGHT_RDB_EMPTY = -4,
    SERIAL_RIGHT_PERMISSION_DENIED = -5,
    SERIAL_RIGHT_NOP = -6,
    SERIAL_RIGHT_OVERFLOW = -7,
};

} // namespace USB
} // namespace OHOS
#endif // SERIAL_ERRORS_H
