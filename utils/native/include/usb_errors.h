...
enum UsbErrCode {
    ...
    UEC_SERVICE_HOST_NOT_SUPPORT,
    UEC_SERVICE_DEVICE_NOT_SUPPORT,
    UEC_SERVICE_PORT_NOT_SUPPORT,
    UEC_MANAGER_PORT_REPEAT_OPEN,
    UEC_MANAGER_PORT_REPEAT_CLOSE,
    UEC_MANAGER_PORT_NOT_OPEN,
    UEC_MANAGER_IO_EXCEPTION,
    UEC_MANAGER_DEVICENOTOPEN,
    UEC_SERIAL_INTERFACE_ERROR
};
